public class BarcodeOld implements Comparable<BarcodeOld>{
// instance variables
   private String _zip;
...
// postcondition: Creates a copy of a bar code.
  public BarcodeOld clone(){
      BarcodeOld b = new BarcodeOld(_zip);
      return b;
}
...
public int compareTo(BarcodeOld other){
